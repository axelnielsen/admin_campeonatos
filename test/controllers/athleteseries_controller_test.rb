...
class AthleteseriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athleteseries" do
    assert_difference('Athleteserie.count') do
      post athleteseries_url, params: { athleteseries: { idAthlete: @athleteseries.idAthlete, idSerie: @athleteseries.idSerie, idStatus: @athleteseries.idStatus } }
    end

    assert_redirected_to athleteseries_url(Athleteserie.last)
  end
  ...
  test "should destroy athleteseries" do
    assert_difference('Athleteserie.count', -1) do
      delete athleteseries_url(@athleteseries)
    end

    assert_redirected_to athleteseries_url
  end
end
