class AthleteseriesController < ApplicationController
  ...
  def index
    @athleteseries = Athleteserie.all
  end
  ...
  def new
    @athleteseries = Athleteserie.new
  end
  ...
  def create
    @athleteseries = Athleteserie.new(athleteseries_params)

    respond_to do |format|
      if @athleteseries.save
        format.html { redirect_to @athleteseries, notice: 'Athleteserie was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @athleteseries.update(athleteseries_params)
        format.html { redirect_to @athleteseries, notice: 'Athleteserie was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to athleteseries_url, notice: 'Athleteserie was successfully destroyed.' }
  ...
  private
    ...
    def set_athleteseries
      @athleteseries = Athleteserie.find(params[:id])
    end
